...
import com.example.posts.presentations.postDetails.PostDetailsScreen
...
import com.example.posts.presentations.userDetails.userInfo.UserInfoScreen
...
import com.example.posts.presentations.userslist.composables.UserScreen
...
fun Navigation(navController: NavHostController) {
    NavHost(navController = navController, startDestination ="home" ){
        ...
        arguments = listOf(navArgument("post_id"){
            ...
            val vm : PostDetailsViewModel= hiltViewModel()
            PostDetailsScreen(vm)
        }
        ...
        composable(route = "users"){
            ...
            UserScreen(usersScreenState = vm.state.value){ id ->
